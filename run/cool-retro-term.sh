...
echo "The fxOS theme at '$dir/cool-retro-term.json' have to be manually imported."

# Launch qemu inside cool-retro-term
cool-retro-term --fullscreen --profile "fxOS" --workdir "$dir/.." -e sh -c "$qemu 2>/dev/null"
