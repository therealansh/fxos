...
pub fn copy_files(verbose: bool) {
    ...
    // copy_file("/bin/fxlang", include_bytes!("../../dsk/bin/fxlang"), verbose);
    ...
    copy_file("/ini/light.csv",include_bytes!("../../dsk/ini/light.csv"),verbose);
    ...
    // copy_file("/tmp/fxlang.sh", include_bytes!("../../dsk/tmp/fxlang"), verbose);
...
pub fn main(args: &[&str]) -> Result<(), ExitCode> {
    ...
    println!("{}Welcome to fxOS v{} installation program!{}", csi_color, env!("CARGO_PKG_VERSION"), csi_reset);
    println!();
